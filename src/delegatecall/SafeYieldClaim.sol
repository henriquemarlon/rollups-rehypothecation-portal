...
contract SafeYieldClaim {
    ...
    /// @dev This function should be called via delegatecall from the application contract. It calculates yield as: current vault value - total supply managed off-chain. In delegatecall context, address(this) is the application holding the vault shares.
        ...
        returns (uint256 yieldClaimed)
    {
        ...
        uint256 rehypothecatedAssets = vault.previewRedeem(rehypothecatedShares);
